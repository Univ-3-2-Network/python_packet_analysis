...
def traceroute_like(target_ip, max_hops=15, timeout=3):
    """
    ...
    # Show local IP and interface for debugging
    print(f"Local IP: {uml.local_ip}")
    print(f"Target IP: {target_ip}")
    print(f"Network Interface: {conf.iface}")
    print(f"Timeout per hop: {timeout}s")
    print("=" * 80)
